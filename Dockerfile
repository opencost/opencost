...
ADD --chmod=600 ./configs/default.json /models/default.json
ADD --chmod=600 ./configs/azure.json /models/azure.json
ADD --chmod=600 ./configs/aws.json /models/aws.json
ADD --chmod=600 ./configs/gcp.json /models/gcp.json
ADD --chmod=600 ./configs/alibaba.json /models/alibaba.json
ADD --chmod=600 ./configs/oracle.json /models/oracle.json
ADD --chmod=600 ./configs/otc.json /models/otc.json
