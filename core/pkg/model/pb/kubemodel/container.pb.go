...
// 	protoc        v6.32.1
// source: protos/kubemodel/container.proto
...
func (x *Container) Reset() {
	*x = Container{}
	mi := &file_protos_kubemodel_container_proto_msgTypes[0]
...
func (*Container) Descriptor() ([]byte, []int) {
	return file_protos_kubemodel_container_proto_rawDescGZIP(), []int{0}
}
...
var File_protos_kubemodel_container_proto protoreflect.FileDescriptor

const file_protos_kubemodel_container_proto_rawDesc = "" +
	"\n" +
	" protos/kubemodel/container.proto\x12\tkubemodel\x1a!protos/kubemodel/diagnostic.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa4\x05\n" +
	"\tContainer\x12\x14\n" +
...
var (
	file_protos_kubemodel_container_proto_rawDescOnce sync.Once
	file_protos_kubemodel_container_proto_rawDescData []byte
)

func file_protos_kubemodel_container_proto_rawDescGZIP() []byte {
	file_protos_kubemodel_container_proto_rawDescOnce.Do(func() {
		file_protos_kubemodel_container_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_kubemodel_container_proto_rawDesc), len(file_protos_kubemodel_container_proto_rawDesc)))
	})
	return file_protos_kubemodel_container_proto_rawDescData
}

var file_protos_kubemodel_container_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_protos_kubemodel_container_proto_goTypes = []any{
	(*Container)(nil),             // 0: kubemodel.Container
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
	(*DiagnosticResult)(nil),      // 2: kubemodel.DiagnosticResult
}
var file_protos_kubemodel_container_proto_depIdxs = []int32{
...
func init() { file_protos_kubemodel_container_proto_init() }
func file_protos_kubemodel_container_proto_init() {
	if File_protos_kubemodel_container_proto != nil {
		return
	}
	file_protos_kubemodel_diagnostic_proto_init()
	file_protos_kubemodel_container_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_kubemodel_container_proto_rawDesc), len(file_protos_kubemodel_container_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_protos_kubemodel_container_proto_goTypes,
		DependencyIndexes: file_protos_kubemodel_container_proto_depIdxs,
		MessageInfos:      file_protos_kubemodel_container_proto_msgTypes,
	}.Build()
	File_protos_kubemodel_container_proto = out.File
	file_protos_kubemodel_container_proto_goTypes = nil
	file_protos_kubemodel_container_proto_depIdxs = nil
}
