...
// 	protoc        v6.32.1
// source: protos/kubemodel/namespace.proto
...
func (x *Namespace) Reset() {
	*x = Namespace{}
	mi := &file_protos_kubemodel_namespace_proto_msgTypes[0]
...
func (*Namespace) Descriptor() ([]byte, []int) {
	return file_protos_kubemodel_namespace_proto_rawDescGZIP(), []int{0}
}
...
var File_protos_kubemodel_namespace_proto protoreflect.FileDescriptor

const file_protos_kubemodel_namespace_proto_rawDesc = "" +
	"\n" +
	" protos/kubemodel/namespace.proto\x12\tkubemodel\x1a!protos/kubemodel/diagnostic.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc8\x04\n" +
	"\tNamespace\x12\x0e\n" +
...
var (
	file_protos_kubemodel_namespace_proto_rawDescOnce sync.Once
	file_protos_kubemodel_namespace_proto_rawDescData []byte
)

func file_protos_kubemodel_namespace_proto_rawDescGZIP() []byte {
	file_protos_kubemodel_namespace_proto_rawDescOnce.Do(func() {
		file_protos_kubemodel_namespace_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_kubemodel_namespace_proto_rawDesc), len(file_protos_kubemodel_namespace_proto_rawDesc)))
	})
	return file_protos_kubemodel_namespace_proto_rawDescData
}

var file_protos_kubemodel_namespace_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_protos_kubemodel_namespace_proto_goTypes = []any{
...
var file_protos_kubemodel_namespace_proto_depIdxs = []int32{
...
func init() { file_protos_kubemodel_namespace_proto_init() }
func file_protos_kubemodel_namespace_proto_init() {
	if File_protos_kubemodel_namespace_proto != nil {
		return
	}
	file_protos_kubemodel_diagnostic_proto_init()
	file_protos_kubemodel_namespace_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_kubemodel_namespace_proto_rawDesc), len(file_protos_kubemodel_namespace_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_protos_kubemodel_namespace_proto_goTypes,
		DependencyIndexes: file_protos_kubemodel_namespace_proto_depIdxs,
		MessageInfos:      file_protos_kubemodel_namespace_proto_msgTypes,
	}.Build()
	File_protos_kubemodel_namespace_proto = out.File
	file_protos_kubemodel_namespace_proto_goTypes = nil
	file_protos_kubemodel_namespace_proto_depIdxs = nil
}
