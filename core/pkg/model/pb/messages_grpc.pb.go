...
func (c *customCostsSourceClient) GetCustomCosts(ctx context.Context, in *CustomCostRequest, opts ...grpc.CallOption) (*CustomCostResponseSet, error) {
	...
	err := c.cc.Invoke(ctx, CustomCostsSource_GetCustomCosts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCustomCostsSourceServer must be embedded to have
...
func (UnimplementedCustomCostsSourceServer) testEmbeddedByValue()                           {}
...
func RegisterCustomCostsSourceServer(s grpc.ServiceRegistrar, srv CustomCostsSourceServer) {
	// If the following call pancis, it indicates UnimplementedCustomCostsSourceServer was
