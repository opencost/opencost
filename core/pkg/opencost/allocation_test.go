...
func TestAllocationSet_AggregateBy(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"1f": {
			...
			totalCost:  activeTotalCost + idleTotalCost,
			results: map[string]float64{
				"deployment:namespace2:deployment2":   24.00,
				"daemonset:namespace2:daemonset1":     12.00,
				"deployment:namespace3:deployment3":   6.00,
				"statefulset:namespace3:statefulset1": 12.00,
				"deployment:namespace1:deployment1":   12.00,
				IdleSuffix:                            30.00,
				UnallocatedSuffix:                     16.00,
			},
			windowStart: startYesterday,
