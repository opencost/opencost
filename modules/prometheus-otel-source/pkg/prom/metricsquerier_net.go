...
func (pds *PrometheusMetricsQuerier) QueryNetZoneGiB(start, end time.Time) *source.Future[source.NetZoneGiBResult] {
	...
	return source.NewFuture(source.DecodeNetZoneGiBResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetZonePricePerGiB(start, end time.Time) *source.Future[source.NetZonePricePerGiBResult] {
	...
	return source.NewFuture(source.DecodeNetZonePricePerGiBResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetRegionGiB(start, end time.Time) *source.Future[source.NetRegionGiBResult] {
	...
	return source.NewFuture(source.DecodeNetRegionGiBResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetRegionPricePerGiB(start, end time.Time) *source.Future[source.NetRegionPricePerGiBResult] {
	...
	return source.NewFuture(source.DecodeNetRegionPricePerGiBResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetInternetGiB(start, end time.Time) *source.Future[source.NetInternetGiBResult] {
	...
	return source.NewFuture(source.DecodeNetInternetGiBResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetInternetPricePerGiB(start, end time.Time) *source.Future[source.NetInternetPricePerGiBResult] {
	...
	return source.NewFuture(source.DecodeNetInternetPricePerGiBResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetInternetServiceGiB(start, end time.Time) *source.Future[source.NetInternetServiceGiBResult] {
	...
	return source.NewFuture(source.DecodeNetInternetServiceGiBResult, pds.promContexts.NewNamedContext(NetworkInsightsContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetTransferBytes(start, end time.Time) *source.Future[source.NetTransferBytesResult] {
	...
	return source.NewFuture(source.DecodeNetTransferBytesResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetZoneIngressGiB(start, end time.Time) *source.Future[source.NetZoneIngressGiBResult] {
	...
	return source.NewFuture(source.DecodeNetZoneIngressGiBResult, pds.promContexts.NewNamedContext(NetworkInsightsContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetRegionIngressGiB(start, end time.Time) *source.Future[source.NetRegionIngressGiBResult] {
	...
	return source.NewFuture(source.DecodeNetRegionIngressGiBResult, pds.promContexts.NewNamedContext(NetworkInsightsContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetInternetIngressGiB(start, end time.Time) *source.Future[source.NetInternetIngressGiBResult] {
	...
	return source.NewFuture(source.DecodeNetInternetIngressGiBResult, pds.promContexts.NewNamedContext(NetworkInsightsContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetInternetServiceIngressGiB(start, end time.Time) *source.Future[source.NetInternetServiceIngressGiBResult] {
	...
	return source.NewFuture(source.DecodeNetInternetServiceIngressGiBResult, pds.promContexts.NewNamedContext(NetworkInsightsContextName).QueryAtTime(q, end))
}
...
func (pds *PrometheusMetricsQuerier) QueryNetReceiveBytes(start, end time.Time) *source.Future[source.NetReceiveBytesResult] {
	...
	return source.NewFuture(source.DecodeNetReceiveBytesResult, pds.promContexts.NewNamedContext(AllocationContextName).QueryAtTime(q, end))
}
