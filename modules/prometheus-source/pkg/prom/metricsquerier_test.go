...
func TestQueryLogs(t *testing.T) {
	...
	tests := map[string]func(time.Time, time.Time){
		...
		"QueryResourceQuotaSpecCPURequests":       func(s, e time.Time) { querier.QueryResourceQuotaSpecCPURequests(s, e) },
		"QueryResourceQuotaSpecRAMRequests":       func(s, e time.Time) { querier.QueryResourceQuotaSpecRAMRequests(s, e) },
		"QueryResourceQuotaSpecCPULimits":         func(s, e time.Time) { querier.QueryResourceQuotaSpecCPULimits(s, e) },
		"QueryResourceQuotaSpecRAMLimits":         func(s, e time.Time) { querier.QueryResourceQuotaSpecRAMLimits(s, e) },
		"QueryResourceQuotaStatusUsedCPURequests": func(s, e time.Time) { querier.QueryResourceQuotaStatusUsedCPURequests(s, e) },
		"QueryResourceQuotaStatusUsedRAMRequests": func(s, e time.Time) { querier.QueryResourceQuotaStatusUsedRAMRequests(s, e) },
		"QueryResourceQuotaStatusUsedCPULimits":   func(s, e time.Time) { querier.QueryResourceQuotaStatusUsedCPULimits(s, e) },
		"QueryResourceQuotaStatusUsedRAMLimits":   func(s, e time.Time) { querier.QueryResourceQuotaStatusUsedRAMLimits(s, e) },
	}
