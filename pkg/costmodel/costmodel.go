...
func (cm *CostModel) costDataRange(cli prometheusClient.Client, cp costAnalyzerCloud.Provider, window kubecost.Window, resolution time.Duration, filterNamespace string, filterCluster string, remoteEnabled bool) (map[string]*CostData, error) {
	...
	queryRAMAlloc := fmt.Sprintf(queryRAMAllocationByteHours, env.GetPromFilterLabel(), resStr, env.GetPromClusterLabel(), scrapeIntervalSeconds)
	queryCPUAlloc := fmt.Sprintf(queryCPUAllocationVCPUHours, env.GetPromFilterLabel(), resStr, env.GetPromClusterLabel(), scrapeIntervalSeconds)
	queryRAMRequests := fmt.Sprintf(queryRAMRequestsStr, env.GetPromFilterLabel(), resStr, "", env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel(), env.GetPromClusterLabel())
	queryRAMUsage := fmt.Sprintf(queryRAMUsageStr, env.GetPromFilterLabel(), resStr, "", env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel())
	queryCPURequests := fmt.Sprintf(queryCPURequestsStr, env.GetPromFilterLabel(), resStr, "", env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel(), env.GetPromClusterLabel())
	queryCPUUsage := fmt.Sprintf(queryCPUUsageStr, env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel())
	queryGPURequests := fmt.Sprintf(queryGPURequestsStr, env.GetPromFilterLabel(), resStr, "", env.GetPromFilterLabel(), resStr, "", resolution.Hours(), env.GetPromClusterLabel(), env.GetPromClusterLabel(), env.GetPromClusterLabel(), env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel())
	queryPVRequests := fmt.Sprintf(queryPVRequestsStr, env.GetPromFilterLabel(), env.GetPromClusterLabel(), env.GetPromClusterLabel(), env.GetPromFilterLabel(), env.GetPromClusterLabel(), env.GetPromClusterLabel())
	queryPVCAllocation := fmt.Sprintf(queryPVCAllocationFmt, env.GetPromFilterLabel(), resStr, env.GetPromClusterLabel(), scrapeIntervalSeconds)
	queryPVHourlyCost := fmt.Sprintf(queryPVHourlyCostFmt, env.GetPromFilterLabel(), resStr)
	queryNetZoneRequests := fmt.Sprintf(queryZoneNetworkUsage, env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel())
	queryNetRegionRequests := fmt.Sprintf(queryRegionNetworkUsage, env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel())
	queryNetInternetRequests := fmt.Sprintf(queryInternetNetworkUsage, env.GetPromFilterLabel(), resStr, "", env.GetPromClusterLabel())
	queryNormalization := fmt.Sprintf(normalizationStr, env.GetPromFilterLabel(), resStr, "")
	...
	resChNSLabels := ctx.QueryRange(fmt.Sprintf(queryNSLabels, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChPodLabels := ctx.QueryRange(fmt.Sprintf(queryPodLabels, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChNSAnnotations := ctx.QueryRange(fmt.Sprintf(queryNSAnnotations, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChPodAnnotations := ctx.QueryRange(fmt.Sprintf(queryPodAnnotations, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChServiceLabels := ctx.QueryRange(fmt.Sprintf(queryServiceLabels, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChDeploymentLabels := ctx.QueryRange(fmt.Sprintf(queryDeploymentLabels, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChStatefulsetLabels := ctx.QueryRange(fmt.Sprintf(queryStatefulsetLabels, env.GetPromFilterLabel(), resStr), start, end, resolution)
	resChJobs := ctx.QueryRange(fmt.Sprintf(queryPodJobs, env.GetPromFilterLabel(), env.GetPromClusterLabel()), start, end, resolution)
	resChDaemonsets := ctx.QueryRange(fmt.Sprintf(queryPodDaemonsets, env.GetPromFilterLabel(), env.GetPromClusterLabel()), start, end, resolution)
