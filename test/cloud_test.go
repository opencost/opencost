...
func TestRegionValueFromMapField(t *testing.T) {
	...
	got := csv.NodeValueFromMapField(providerIDMap, n, true)
...
func TestTransformedValueFromMapField(t *testing.T) {
	...
	got := csv.NodeValueFromMapField(providerIDMap, n, false)
	if got != providerIDWant {
		t.Errorf("Assert on '%s' want '%s' got '%s'", providerIDMap, providerIDWant, got)
	}
	...
	got2 := csv.NodeValueFromMapField(providerIDMap, n2, false)
	...
	got3 := csv.NodeValueFromMapField(providerIDMap, n3, false)
...
func TestNodeValueFromMapField(t *testing.T) {
	...
	got = csv.NodeValueFromMapField(nameMap, n, false)
	if got != nameWant {
		t.Errorf("Assert on '%s' want '%s' got '%s'", nameMap, nameWant, got)
	}

	got = csv.NodeValueFromMapField(labelMapFoo, n, false)
	if got != labelFooWant {
